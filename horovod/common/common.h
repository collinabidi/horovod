...
#define SHMEMCPY_IN_FUSION_BUFFER "MEMCPY_IN_FUSION_BUFFER"
#define SHMEMCPY_IN_HOST_BUFFER "MEMCPY_IN_HOST_BUFFER"
#define SHMEMCPY_IN_SHARED_BUFFER "MEMCPY_IN_SHARED_BUFFER"
...
#define SHMEM_ALLREDUCE "SHMEM_ALLREDUCE"
#define SHMEM_ALLGATHER "SHMEM_ALLGATHER"
#define SHMEM_BCAST "SHMEM_BCAST"

// Horovod knobs.
#define HOROVOD_MPI_THREADS_DISABLE "HOROVOD_MPI_THREADS_DISABLE"
#define HOROVOD_SHMEM_THREADS_DISABLE "HOROVOD_SHMEM_THREADS_DISABLE"
...
// Flag for when SHMEM allocates and de-allocates symmetric memory/variables
#define SHMEM_MALLOC "SHMEM_MALLOC"
#define SHMEM_FREE "SHMEM_FREE"
